...
{
	public class SmallGroupsController : DialogViewController
	{
		public SmallGroupsController () : base (UITableViewStyle.Grouped, null, true)
		{
			...
			var root = new RootElement ("Small Groups"){
